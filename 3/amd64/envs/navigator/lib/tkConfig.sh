...
# installed.
TK_PREFIX='/home/ubuntu/tools/miniconda/3/amd64/envs/navigator'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/home/ubuntu/tools/miniconda/3/amd64/envs/navigator'
...
# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/home/ubuntu/tools/miniconda/3/amd64/envs/navigator/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/home/ubuntu/tools/miniconda/3/amd64/envs/navigator/include'
...
# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/home/ubuntu/tools/miniconda/3/amd64/envs/navigator/lib -ltkstub8.6'
...
TK_STUB_LIB_PATH='/home/ubuntu/tools/miniconda/3/amd64/envs/navigator/lib/libtkstub8.6.a'
