...
# installed.
TCL_PREFIX='/home/buildadm/miniconda/3/amd64/envs/devops'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/home/buildadm/miniconda/3/amd64/envs/devops'
...
TCL_EXTRA_CFLAGS='-march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -pipe -I/home/buildadm/miniconda/3/amd64/envs/devops/include -fdebug-prefix-map=${SRC_DIR}=/usr/local/src/conda/${PKG_NAME}-${PKG_VERSION} -fdebug-prefix-map=${PREFIX}=/usr/local/src/conda-prefix -pipe -m64 -DNDEBUG -D_FORTIFY_SOURCE=2 -O2'
...
TCL_LD_FLAGS='-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,--disable-new-dtags -Wl,-rpath,/home/buildadm/miniconda/3/amd64/envs/devops/lib -L/home/buildadm/miniconda/3/amd64/envs/devops/lib -Wl,--export-dynamic '
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/home/buildadm/miniconda/3/amd64/envs/devops/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/home/buildadm/miniconda/3/amd64/envs/devops/include'
...
TCL_PACKAGE_PATH='/home/buildadm/miniconda/3/amd64/envs/devops/lib '
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/home/buildadm/miniconda/3/amd64/envs/devops/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/tmp/build/80754af9/tk_1535485056075/work/tcl8.6.8/unix/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/home/buildadm/miniconda/3/amd64/envs/devops/lib/libtclstub8.6.a'
