...
# installed.
TCL_PREFIX='/home/buildadm/tools/miniconda/3/amd64'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/home/buildadm/tools/miniconda/3/amd64'
...
TCL_EXTRA_CFLAGS='-march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe -isystem /home/buildadm/tools/miniconda/3/amd64/include -fdebug-prefix-map=/tmp/build/80754af9/tk_1592503156360/work=/usr/local/src/conda/tk-8.6.10 -fdebug-prefix-map=/home/buildadm/tools/miniconda/3/amd64=/usr/local/src/conda-prefix -pipe -m64 -DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem /home/buildadm/tools/miniconda/3/amd64/include'
...
TCL_LD_FLAGS='-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,--disable-new-dtags -Wl,--gc-sections -Wl,-rpath,/home/buildadm/tools/miniconda/3/amd64/lib -Wl,-rpath-link,/home/buildadm/tools/miniconda/3/amd64/lib -L/home/buildadm/tools/miniconda/3/amd64/lib -Wl,--export-dynamic '
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/home/buildadm/tools/miniconda/3/amd64/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/home/buildadm/tools/miniconda/3/amd64/include'
...
TCL_PACKAGE_PATH='/home/buildadm/tools/miniconda/3/amd64/lib '
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/home/buildadm/tools/miniconda/3/amd64/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/tmp/build/80754af9/tk_1592503156360/work/tcl8.6.10/unix/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/home/buildadm/tools/miniconda/3/amd64/lib/libtclstub8.6.a'
